...
* entry[Versichertenanspruch].resource only AtMopedCoverageVersicherterBasis or AtMopedCoverageSelbstzahlerBasis
...
* entry[Hauptversicherter].resource only AtMopedRelatedPersonHauptversicherterBasis
...
* entry contains
  Frageboegen 0..
* entry[Frageboegen].resource only AtMopedQuestionnaireResponseFallbezogen
