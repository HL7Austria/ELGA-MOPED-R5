Profile: AtMopedCompositionGenerisch
Parent: Composition
...
* section[Bewegungen].code.coding.code = #BENC
* section[Bewegungen].entry 1..
* section[Bewegungen].entry only Reference(AtMopedEncounterBewegungIntensivBasis or AtMopedEncounterBewegungAmbulantBasis or AtMopedEncounterBewegungStationaerBasis)
...
* section[zustaendigeSV].entry only Reference(AtMopedOrganizationSV)
...
* section[zustaendigerLGF].entry only Reference(AtMopedOrganizationLGF)
...
* section[zustaendigeKA].entry only Reference(AtMopedOrganizationKA)
...
* section[besuchteAbteilungen].entry only Reference(AtMopedOrganizationOrganisationseinheitKA)
* section[besuchteAbteilungen].author only Reference(AtMopedOrganizationKA)
...
* section[Diagnosen].entry only Reference(AtMopedConditionBasis)
...
* section[Leistungen].entry only Reference(AtMopedProcedureBasis)
* section[Leistungen].author only Reference(AtMopedOrganizationKA)
...
* section[Versichertenanspruch].entry only Reference(AtMopedCoverageVersicherterBasis or AtMopedCoverageSelbstzahlerBasis)
* section[Versichertenanspruch].author only Reference(AtMopedOrganizationKA)
...
* section[VAERequests].entry only Reference(AtMopedClaimVAERequestInitial or AtMopedClaimVAERequestVerlaengerung)
* section[VAERequests].author only Reference(AtMopedOrganizationKA)
...
* section[VAEResponses].entry only Reference(AtMopedClaimResponseVAEResponseGenerisch)
* section[VAEResponses].author only Reference(AtMopedOrganizationSV)
...
* section[LKFRequests].entry only Reference(AtMopedClaimLKFRequestBasis)
* section[LKFRequests].author only Reference(AtMopedOrganizationKA)
...
* section[LKFResponses].entry only Reference(AtMopedClaimResponseLKFResponseBasis)
* section[LKFResponses].author only Reference(AtMopedOrganizationLGF)
...
* section[ARKKostenInformation].author only Reference(AtMopedOrganizationKA)
...
* section[ARKRueckmeldung].author only Reference(AtMopedOrganizationLGF)
...
* section[ARKStatusUpdate].author only Reference(AtMopedOrganizationLGF)
...
* section[Entbindung].entry only Reference(MopedObservationGeburtenanzahl or AtMopedObservationEntbindungsartBasis)
* section[Entbindung].author only Reference(AtMopedOrganizationKA)
...
* section[Hauptversicherter].entry only Reference(AtMopedRelatedPersonHauptversicherterBasis)
* section[Hauptversicherter].author only Reference(AtMopedOrganizationKA)
...
* section[Frageboegen].entry only Reference(AtMopedQuestionnaireResponseFallbezogen)
* section[Frageboegen].author only Reference(AtMopedOrganizationKA)
...
* section[Kommunikation].author only Reference(AtMopedOrganizationKA or AtMopedOrganizationSV or AtMopedOrganizationLGF)
