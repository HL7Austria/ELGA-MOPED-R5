Profile: AtMopedCompositionBasis
...
Severity: #error
Description: "Der Patient darf zu jedem Zeitpunkt nur auf genau einer Station liegen => Die Zeiträume der BewegungsEncounters dürfen sich nicht überschneiden."
Expression: ""
