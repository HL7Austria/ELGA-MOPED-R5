...
* insert ShallPopulateObligation(status, MopedActor)
* insert ShallPopulateObligation(type, MopedActor)
* insert ShallPopulateObligation(date, MopedActor)
* insert ShallPopulateObligation(title, MopedActor)
* subject only Reference(HL7ATCorePatient)
* subject 1..1
* insert ShallPopulateObligation(subject, MopedActor)
* encounter only Reference(MopedEncounterA or MopedEncounterS)
* encounter 1..1
* insert ShallPopulateObligation(encounter, MopedActor)
* ^experimental = true
* useContext 1..*
* useContext ^slicing.discriminator[+].type = #value
* useContext ^slicing.discriminator[=].path = "code"
* useContext ^slicing.rules = #open
* insert ShallPopulateObligation(useContext, MopedActor)
* useContext contains
  Workflow 1..1
...
* insert ShallPopulateObligation(author, MopedActor)
* extension contains AnzahlVerlegungen named AnzahlVerlegungen 0..1
* insert ShallPopulateObligation(extension[AnzahlVerlegungen], MopedActor)
* extension contains AnzahlBeurlaubungen named AnzahlBeurlaubungen 0..1
* extension[AnzahlBeurlaubungen] ^short = "KaOrg: Fallnummer"
* insert ShallPopulateObligation(extension[AnzahlBeurlaubungen], MopedActor)
* section 1..*
...
//* insert ObligationActor(section, MopedActor)
...
* insert ShallPopulateObligation(section[TransferEncounter], MopedActor)
...
* insert ShallPopulateObligation(section[zustaendigeSV], MopedActor)
...
* insert ShallPopulateObligation(section[zustaendigerLGF], MopedActor)
...
* insert ShallPopulateObligation(section[zustaendigesKH], MopedActor)
...
* insert ShallPopulateObligation(section[besuchteAbteilungen], MopedActor)
...
* insert ShallPopulateObligation(section[Diagnosen], MopedActor)
...
* insert ShallPopulateObligation(section[Leistungen], MopedActor)
...
* insert ShallPopulateObligation(section[Coverages], MopedActor)
...
* insert ShallPopulateObligation(section[VAERequests], MopedActor)
...
* insert ShallPopulateObligation(section[VAEResponses], MopedActor)
...
* insert ShallPopulateObligation(section[LKFRequests], MopedActor)
...
* insert ShallPopulateObligation(section[LKFResponses], MopedActor)
...
* insert ShallPopulateObligation(section[ARKKostenInformation], MopedActor)
...
* insert ShallPopulateObligation(section[ARKRueckmeldung], MopedActor)
...
* insert ShallPopulateObligation(section[ARKStatusUpdate], MopedActor)
...
* insert ShallPopulateObligation(section[Observations], MopedActor)
...
* insert ShallPopulateObligation(section[Hauptversicherter], MopedActor)
...
* insert ShallPopulateObligation(section[Frageboegen], MopedActor)
...
* insert ShallPopulateObligation(section[Kommunikation], MopedActor)