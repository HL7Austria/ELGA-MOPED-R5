...
Extension: MopedSupportingInfoVortageanzahlAufKostenbeitrag
...
* extension[category].valueCodeableConcept.coding = ClaimSupportingInformationCategoryCS#VTAGE
* extension[code] ^short = "Type of information"
* extension[code].value[x] 1..1
* extension[code].value[x] only CodeableConcept
* extension[code].value[x] from SonderklasseVS
...
* extension[value].value[x] only Quantity //use unsignedInt in R6
* extension[value].valueQuantity.value 1..1 
