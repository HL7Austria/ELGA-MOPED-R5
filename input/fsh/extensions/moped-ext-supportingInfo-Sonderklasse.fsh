Extension: MopedSupportingInfoSonderklasse
Title: "Supporting Info Extension for ClaimResponse - Sonderklasse Slice"
...
* extension[category].valueCodeableConcept.coding = ClaimSupportingInformationCategoryCS#KLAS
