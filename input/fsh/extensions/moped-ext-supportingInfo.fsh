Extension: MopedSupportingInfo
Title: "Supporting Info Extension for ClaimResponse"
...
* extension[value].value[x] only boolean or string or Attachment or Quantity or Reference
