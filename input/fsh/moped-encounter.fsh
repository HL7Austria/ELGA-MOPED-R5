...
* identifier[Aufnahmezahl].type from http://terminology.hl7.org/CodeSystem/v2-0203 (required)
...
* identifier[DatensatzID].type from http://terminology.hl7.org/CodeSystem/v2-0203 (required)
