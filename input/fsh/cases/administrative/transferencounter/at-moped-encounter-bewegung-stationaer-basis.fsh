Profile: AtMopedEncounterBewegungStationaerBasis
...
* insert ShallPopulateObligation(admission.extension[Altersgruppe].extension[neugeborenes].value[x], MopedKAActor)
