Profile: AtMopedEncounterAufenthaltBesuchGenerisch
Parent: Encounter
Id: at-moped-encounter-aufenthaltbesuch-generisch
Title: "AT MOPED Encounter Aufenthalt/Besuch generisches Profil"
...
* identifier[Aufnahmezahl].assigner only Reference(AtMopedOrganizationKA)
...
* subject only Reference(AtMopedPatientKlarnameBasis or AtMopedPatientvbPKBasis)
* subject 1..1
* insert MopedHandleObligation(subject)

* serviceProvider only Reference(AtMopedOrganizationKA)
* serviceProvider 1..1
