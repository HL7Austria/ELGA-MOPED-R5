...
Profile: AtMopedClaimVAERequestGenerisch
Parent: Claim
...
* related.claim only Reference(AtMopedClaimVAERequestGenerisch) //bei Verlängerungsanträgen als Referenz zum initialen
