...
//performer.actor ist aber nicht befüllbar, wenn die Leistung unabhängig von der leistungserbringenden Abteilung bzw. unabhängig von der Verlegung innerhalb dieser KA abgerechnet wird
