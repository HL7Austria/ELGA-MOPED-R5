...
* $VerdachtArbeitsSchuelerunfall#3 "Landwirtschaftlicher Unfall"
* $VerdachtArbeitsSchuelerunfall#4 "Wegunfall Arbeit"
* $VerdachtArbeitsSchuelerunfall#5 "Wegunfall Schüler/Student"
* $VerdachtArbeitsSchuelerunfall#0 "Nein/Unbekannt"
