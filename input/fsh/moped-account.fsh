...
* extension contains CoverageEligibilityRequestRef named deckungsBerechtigungsRequestReferenz 0..1
* extension contains ClaimRef named anspruchsReferenz 0..1