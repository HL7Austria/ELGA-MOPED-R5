Instance: LKFK08Questionnaire
InstanceOf: Questionnaire
Usage: #example
* title = "LKF K08 Questionnaire"
* status = #active
...
* item[+].type = #integer
* item[=].maxLength = 8
* item[=].linkId = "bettenführende-hauptkostenstelle-funktionscode"
* item[=].text = "Bettenführende Hauptkostenstelle – Funktionscode"
* item[+].type = #integer
* item[=].maxLength = 6
* item[=].linkId = "systemisierte-betten"
* item[=].text = "Systemisierte Betten"
* item[+].type = #integer
* item[=].maxLength = 6
* item[=].linkId = "tatsächlich-aufgestellte-betten"
* item[=].text = "Tatsächlich aufgestellte Betten"
* item[+].type = #integer
* item[=].maxLength = 6
